                  ...
                  <div class="row showcase_row_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <select class="custom-select" name="role" id="role" required="">
                        ...
                        <option id="capacity" value="capacity">Capacity</option>
                    ...
                    <td class="actions">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          @if($account->role == 'engineer' || $account->role == 'user' || $account->role == 'capacity')
...
$(document).on('click', '.edit-btn', function(e) {
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      }else if(response.role == 'engineer' || response.role == 'user' || response.role == 'capacity'){
