...
<div class="viewport-header">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb has-arrow">
      ...
      <li class="breadcrumb-item active" aria-current="page">List Reconfigure</li>
    </ol>
  </nav>
</div>
      ...
      <div class="grid">
       <a href="{{ url('/my_repair_machine') }}" class="btn-hover">
        <div class="btn btn-primary has-icon row float-right border-0" style="margin:8px 10px 0px 10px;">
          <i class="mdi mdi-book-multiple"></i>Manage Reconfigure Reconfigure</div>
       </a>
        <p class="grid-header">List Reconfigure</p>
