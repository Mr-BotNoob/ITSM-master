...
<div class="viewport-header">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb has-arrow">
      ...
      <li class="breadcrumb-item">
        <a href="{{ url('/repair_machine') }}">List Deployment</a>
      </li>
      <li class="breadcrumb-item active" aria-current="page">Manage Deployment</li>
    </ol>
  </nav>
</div>
        ...
        <form method="POST" action="{{ url('/save_deployment') }}" id="add_modal">
          <div class="modal-content">
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-lg-12 text-center mt-4">
                  ...
                  <h6 class="mt-4">Add List Deployment</h6>
                </div>
                @csrf
                <div class="col-lg-12 mt-4 mb-4">
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="vmname">App Name</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="ipaddress">Location</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <select class="form-control" id="ipaddress" name="ipaddress" value="" required="">
                      <option value="" disabled selected hidden>-- Select Location --</option>
                      <option value='Plaza'>Plaza</option>
                      <option value='Rempoa'>Rempoa</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary btn-block">Save Deployment</button>
            </div>
          </div>
        </form>
      </div>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-lg-12 mt-4 mb-4">
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_vmname">App Name</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_ipaddress">Location</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
      ...
      <div class="grid">
       <a href="#" role="button" data-toggle="modal" data-target="#addRepair" class="btn-hover btn-add">
        <div class="btn btn-primary has-icon row float-right border-0" style="margin:8px 10px 0px 10px;">
          <i class="mdi mdi-library-plus"></i>Add List Deployment</div>
       </a>
        <p class="grid-header">Manage Deployment</p>
