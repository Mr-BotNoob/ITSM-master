            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-lg-12 text-center mt-4">
                  ...
                  <h6 class="mt-4">Add Application</h6>
                </div>
                @csrf
                <div class="col-lg-12 mt-4 mb-4">
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="crq">CRQ Remedy</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="crq" name="crq" value="" required="" placeholder="Ex : CRQ19451708782023">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="nota">Nota Permintaan</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="nota" name="nota" value="" required="" placeholder="Ex : IFS/1/09/2023">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="eawg">NO EAWG</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="eawg" name="eawg" value="" required="" placeholder="Ex : 1703781731">
                    </div>
                  </div>
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="machine">Application</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="machine" name="machine" value="" required="" placeholder="Ex : Livin">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="brand">Criticality</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <select class="form-control" id="brand" name="brand" value="" required="">
                      <option value="" disabled selected hidden>-- Select Criticality --</option>
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="capacity">PIC</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="capacity" name="capacity" value="" required="" placeholder="Ex : Made Herlambang">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="email" name="email" value="" required="" placeholder="Ex : Made.herlambang@bankmandiri.co.id">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-lg-12 text-center mt-4">
                  ...
                  <h6 class="mt-4">Edit Application</h6>
                </div>
                @csrf
                <div class="col-lg-12 mt-4 mb-4">
                  <div class="form-group row showcase_row_area">
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_crq">CRQ Remedy</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="edit_crq" name="crq" value="" required="" placeholder="Ex : CRQ19451708782023">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_nota">Nota Permintaan</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="edit_nota" name="nota" value="" required="" placeholder="Ex : IFS/1/09/2023">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_eawg">NO EAWG</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="edit_eawg" name="eawg" value="" required="" placeholder="Ex : 1703781731">
                    </div>
                  </div>
                  <div class="row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_lane">Enviroment</label>
                    </div>
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_machine">Application</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_brand">Criticality</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <select class="form-control" id="brand" name="brand" value="" required="">
                      <option value="" disabled selected hidden>-- Select Criticality --</option>
                  ...
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                      <label for="edit_capacity">PIC</label>
                    </div>
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="edit_capacity" name="capacity" value="" required="">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-2 ml-4 showcase_text_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="edit_email" name="email" value="" required="">
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="grid">
       <a href="#" class="btn-hover" role="button" data-toggle="modal" data-target="#addMachine">
        <div class="btn btn-primary has-icon row float-right border-0" style="margin:8px 10px 0px 10px;">
          <i class="mdi mdi-shape-square-plus"></i>Add Application</div>
       </a>
        <p class="grid-header">Manage Application</p>
        <div class="item-wrapper">
          <div class="form-group row showcase_row_area">
            <div class="col-lg-12 pr-4 pl-4 showcase_content_area">
              <input type="text" class="form-control machine-search" value="" placeholder="Search Application">
            </div>
          </div>
              ...
              <tbody id="table-content">
                @foreach($machines as $machine)
                  <tr>
                    ...
                    <td>{{ $machine->crq_remedy }}</td>
                    <td>{{ $machine->nota_permintaan }}</td>
                    <td>{{ $machine->no_eawg }}</td>
