...
Route::group(['middleware' => ['auth', 'checkRole:admin,engineer,user,capacity']], function(){
...
Route::group(['middleware' => ['auth', 'checkRole:admin,engineer,capacity,user']], function(){
	...
	Route::get('/my_deployment', 'DeploymentsManagement@MyImprovement');
